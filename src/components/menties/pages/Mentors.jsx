      ...
      <div className="mx-auto max-w-full">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {paginatedMentorCards.map((m) => (
            <div
              key={m.id || m.name}
              className={`group relative overflow-hidden rounded-2xl bg-white shadow-sm transition-all duration-300 hover:shadow-lg ${m.topMatch
                  ? 'ring-2 ring-[#10b981]'
              ...
              <div className="p-5 sm:p-6">
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        <div className="flex items-center gap-1">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`h-3.5 w-3.5 ${i < Math.floor(m.rating)
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
                  <Link
                    ...
                    className="inline-flex w-full items-center justify-center gap-1.5 rounded-xl py-2.5 text-sm font-medium text-[#6b7280] ring-1 ring-[#e5e7eb] transition-colors hover:text-[#5D3699] hover:ring-[#c4b5fd] sm:w-auto sm:rounded-none sm:py-0 sm:ring-0"
                  >
                  ...
                  <Link
                    ...
                    onClick={() => setSelectedMentorId(m.id)}
                    className={`inline-flex w-full items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold transition-all sm:w-auto ${m.topMatch
        ...
        {totalPages > 1 && (
          <div className="mt-8 flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-white text-[#6b7280] ring-1 ring-[#e5e7eb] transition-all hover:bg-[#f5f3ff] hover:text-[#5D3699] disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="flex items-center gap-1">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((page) => (
                <button
                  ...
                  className={`inline-flex h-11 w-11 items-center justify-center rounded-xl text-sm font-medium transition-all ${currentPage === page
