...
const MentorDetails = () => {
  return (
    <div className="p-4 sm:p-6 overflow-x-hidden">
      <div className="w-full grid lg:grid-cols-[260px_1fr] gap-4 sm:gap-6">
        <Link to="/mentors" className="lg:col-span-2 text-xs text-secondary underline block">
          ← Back
        </Link>
        <aside className="border border-default rounded-2xl bg-surface p-4 sm:p-5 min-w-0" aria-label="Mentor summary">
        ...
        <section className="space-y-4 sm:space-y-5 min-w-0">
          <div className="border border-default rounded-2xl bg-surface p-5">
            <h2 className="flex items-center gap-2 text-sm font-semibold text-primary">
              <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-muted" aria-hidden="true">👤</span>
              About the Mentor
            </h2>
            ...
            <button className="mt-3 text-xs text-secondary underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2" aria-label="Read more about the mentor">
              Read More
            </button>
          </div>
          ...
          <div className="border border-default rounded-2xl bg-surface p-4 sm:p-5">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-sm font-semibold text-primary">
              ...
              <button className="text-xs text-secondary underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2" aria-label="View full availability">
                View Full Availability
              </button>
            </div>
            <div className="mt-4 overflow-x-auto">
              <div className="min-w-[420px] sm:min-w-[520px] grid grid-cols-7 gap-2 text-center text-[10px] text-secondary">
            ...
            <div className="mt-4 grid sm:grid-cols-2 gap-3">
              <div className="rounded-xl border border-default bg-muted p-3 text-xs text-secondary">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-primary">M.Kavin</span>
                  <span>★★★★★</span>
                </div>
                <p className="mt-2">
                  "Lakshmi madam really helped me organize my study schedule. I feel way less stressed now."
                </p>
              </div>
              <div className="rounded-xl border border-default bg-muted p-3 text-xs text-secondary">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-primary">Kavitha Munusamy</span>
                  <span>★★★★★</span>
                </div>
                <p className="mt-2">"Great listener and gave actual actionable advice."</p>
              </div>
            </div>
          </div>
        </section>
