            ...
            {Array.from({ length: 5 }).map((_, i) => {
              ...
              return (
                <button
                  ...
                  className={`group relative p-1 transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#5D3699] focus:ring-offset-2 rounded-lg ${
                    selected ? 'scale-105' : ''
                  }`}
                ...
                >
                  ...
                  <span
                    className={`text-sm transition-colors ${
                      isSelected ? 'text-[#5D3699] font-medium' : 'text-[#6b7280]'
                    }`}
                  >
                    {topic}
                  </span>
